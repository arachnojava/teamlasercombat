...
public class TLCMainMenuScreen extends TLCScreenBase
{
    ...
    private final MHGUIButton btnExit, btnSinglePlayer, btnHostLAN, btnJoinLAN, btnSpectator;
    ...
    public void load()
    {
        ...
        if (credits == null)
            credits = new CreditsDisplay(100, 450, 300);
    ...
    private class CreditsDisplay implements MHRenderable
    {
        ...
        public CreditsDisplay(int x, int y, int width)
        {
            this.x = x;
            this.y = y;
            this.width = width;
            ...
            list.add(new CreditsRecord("Artists", "Kristen", "Miguel"));
            list.add(new CreditsRecord("Artists", "Justin", "Begalka"));
            list.add(new CreditsRecord("MHFramework Game Engine by", "Michael", "Henson"));
            list.add(new CreditsRecord("Level Designers", "Sarah", "Kemper"));
            list.add(new CreditsRecord("Level Designers", "Justin", "Begalka"));
            list.add(new CreditsRecord("Level Designers", "Michael", "Henson"));
            list.add(new CreditsRecord("3D Modelers", "Kristen", "Miguel"));
            list.add(new CreditsRecord("3D Modelers", "Michael", "Henson"));
            list.add(new CreditsRecord("3D Modelers", "Justin", "Begalka"));
